...
INTO product_type (product_type_name,
                   ...
                   lifetime_months)
VALUES
('010-15', 'O2', 'об. дол. %', 30, 0, 12),
('010-18', 'O2', 'об. дол. %', 30, 0, 12),
('035', 'CO', 'мг/м3', 200, 0.1456, 12),
('035.2', 'CO', 'мг/м3', 200, 0.1626, 18),
('035-10', 'H2S', 'мг/м3', 40, 0, 12),
('035-100', 'NO2', 'об. дол. %', 0.014, 0, 12),
('035-102', 'H2S', 'мг/м3', 40, 0, 12),
('035-103', 'Cl2', 'мг/м3', 25, 0, 12),
('035-105', 'CO', 'мг/м3', 200, 0.1456, 12),
('035-111', 'CO', 'мг/м3', 200, 0.1626, 12),
('035-113', 'H2S', 'мг/м3', 40, 0, 12),
('035-114', 'SO2', 'мг/м3', 20, 0, 12),
('035-115', 'Cl2', 'мг/м3', 25, 0, 12),
('035-116', 'Cl2', 'мг/м3', 50, 0, 12),
('035-117', 'NO2', 'мг/м3', 10, 0, 12),
('035-118', 'HCl', 'мг/м3', 30, 0, 12),
('035-128', 'SO2', 'мг/м3', 40, 0, 12),
('035-129', 'SO2', 'мг/м3', 200, 0, 12),
('035-130', 'SO2', 'мг/м3', 3000, 0, 12),
('035-131', 'NO2', 'мг/м3', 100, 0, 12),
('035-132', 'NO2', 'мг/м3', 200, 0, 12),
('035-133', 'NO2', 'мг/м3', 500, 0, 12),
('035-134', 'NO2', 'мг/м3', 3000, 0, 12),
('035-21', 'CO', 'мг/м3', 200, 0.1456, 12),
('035-40', 'CO', 'мг/м3', 200, 0.1456, 12),
('035-52', 'Cl2', 'мг/м3', 25, 0, 12),
('035-54', 'SO2', 'мг/м3', 20, 0, 12),
('035-55', 'NO2', 'мг/м3', 10, 0, 12),
('035-59', 'CO', 'об. дол. %', 0.5, 0.1891, 12),
('035-60', 'CO', 'мг/м3', 200, 0.1891, 12),
('035-61', 'CO', 'ppm', 2000, 0.1891, 12),
('035-62', 'H2S', 'мг/м3', 40, 0, 12),
('035-63', 'Cl2', 'мг/м3', 25, 0, 12),
('035-65', 'SO2', 'ppm', 200, 0, 12),
('035-66', 'SO2', 'ppm', 3000, 0, 12),
('035-69', 'NO2', 'ppm', 140, 0, 12),
('035-69.2', 'NO2', 'об. дол. %', 0.014, 0, 12),
('035-70', 'CO', 'мг/м3', 200, 0.1626, 12),
('035-75', 'NO2', 'мг/м3', 10, 0, 12),
('035-80', 'CO', 'мг/м3', 200, 0.1456, 12),
('035-81', 'CO', 'мг/м3', 1500, 0.1456, 12),
('035-82', 'H2S', 'мг/м3', 40, 0, 12),
('035-83', 'SO2', 'мг/м3', 20, 0, 12),
('035-84', 'Cl2', 'мг/м3', 25, 0, 12),
('035-87', 'NO2', 'мг/м3', 10, 0, 12),
('035-89', 'Cl2', 'мг/м3', 50, 0, 12),
('035-92', 'CO', 'об. дол. %', 0.5, 0.1891, 12),
('035-93', 'CO', 'млн-1', 200, 0.1891, 12),
('035-94', 'CO', 'млн-1', 2000, 0.1891, 12),
('035-95', 'SO2', 'ppm', 200, 0, 12),
('035-96', 'SO2', 'ppm', 20, 0, 12),
('035-99', 'NO2', 'ppm', 140, 0, 12),
('060-10', 'NH3', 'мг/м3', 150, 0, 12),
('060-11', 'NH3', 'мг/м3', 150, 0, 12),
('060-12', 'NH3', 'мг/м3', 2000, 0, 12),
('060-15', 'NH3', 'мг/м3', 600, 0, 12),
('060-16', 'NH3', 'мг/м3', 600, 0, 12),
('060-17', 'NH3', 'мг/м3', 2000, 0, 12),
('060-20', 'NH3', 'мг/м3', 150, 0, 12),
('060-31', 'NH3', 'мг/м3', 150, 0, 12),
('060-32', 'NH3', 'мг/м3', 2000, 0, 12),
('060-33', 'NH3', 'мг/м3', 600, 0, 12),
('060-34', 'NH3', 'мг/м3', 2000, 0, 12),
('100', 'CO', 'мг/м3', 200, 0.0816, 12),
('100-01', 'H2S', 'мг/м3', 40, 0, 12),
('100-02', 'H2S', 'мг/м3', 20, 0, 12),
('100-03', 'SO2', 'мг/м3', 20, 0, 12),
('100-04', 'NO2', 'мг/м3', 10, 0, 12),
('100-05', 'CO', 'мг/м3', 50, 0.0816, 12),
('100-10', 'CO', 'мг/м3', 200, 0.0816, 12),
('100-11', 'H2S', 'мг/м3', 40, 0, 12),
('100-12', 'H2S', 'мг/м3', 20, 0, 12),
('100-13', 'SO2', 'мг/м3', 20, 0, 12),
('100-14', 'NO2', 'мг/м3', 10, 0, 12),
('100-15', 'CO', 'мг/м3', 50, 0.0816, 12),
('100-16', 'Cl2', 'мг/м3', 25, 0, 12),
('100-17', 'НCl', 'мг/м3', 25, 0, 12),
