...
func (v *productTypeTableType) Columns() []string {
	return []string{"product_type_name", "gas_name", "units_name", "scale", "noble_metal_content", "lifetime_months", "min_fon", "max_fon", "max_d_fon", "min_k_sens20", "max_k_sens20", "min_k_sens50", "max_k_sens50", "min_d_temp", "max_d_temp", "max_d_not_measured", "k_sens20", "fon20", "max_d1", "max_d2", "max_d3", "points_method"}
}
...
func (s ProductType) String() string {
	...
	res[18] = "MaxD1: " + reform.Inspect(s.MaxD1, true)
	res[19] = "MaxD2: " + reform.Inspect(s.MaxD2, true)
	res[20] = "MaxD3: " + reform.Inspect(s.MaxD3, true)
	res[21] = "PointsMethod: " + reform.Inspect(s.PointsMethod, true)
