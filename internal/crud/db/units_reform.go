...
var UnitsTable = &unitsTableType{
	s: parse.StructInfo{Type: "Units", SQLSchema: "", SQLName: "units", Fields: []parse.FieldInfo{{Name: "UnitsName", Type: "string", Column: "units_name"}, {Name: "Code", Type: "int64", Column: "code"}}, PKFieldIndex: 0},
	z: new(Units).Values(),
}
