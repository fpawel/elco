...
var ProductTable = &productTableType{
	s: parse.StructInfo{Type: "Product", SQLSchema: "", SQLName: "product", Fields: []parse.FieldInfo{{Name: "ProductID", Type: "int64", Column: "product_id"}, {Name: "PartyID", Type: "int64", Column: "party_id"}, {Name: "Serial", Type: "*int64", Column: "serial"}, {Name: "Place", Type: "int64", Column: "place"}, {Name: "ProductTypeName", Type: "*string", Column: "product_type_name"}, {Name: "Note", Type: "*string", Column: "note"}, {Name: "IFMinus20", Type: "*float64", Column: "i_f_minus20"}, {Name: "IFPlus20", Type: "*float64", Column: "i_f_plus20"}, {Name: "IFPlus50", Type: "*float64", Column: "i_f_plus50"}, {Name: "ISMinus20", Type: "*float64", Column: "i_s_minus20"}, {Name: "ISPlus20", Type: "*float64", Column: "i_s_plus20"}, {Name: "ISPlus50", Type: "*float64", Column: "i_s_plus50"}, {Name: "I13", Type: "*float64", Column: "i13"}, {Name: "I24", Type: "*float64", Column: "i24"}, {Name: "I35", Type: "*float64", Column: "i35"}, {Name: "I26", Type: "*float64", Column: "i26"}, {Name: "I17", Type: "*float64", Column: "i17"}, {Name: "NotMeasured", Type: "*float64", Column: "not_measured"}, {Name: "Firmware", Type: "[]uint8", Column: "firmware"}, {Name: "Production", Type: "bool", Column: "production"}, {Name: "OldProductID", Type: "*string", Column: "old_product_id"}, {Name: "OldSerial", Type: "*int64", Column: "old_serial"}}, PKFieldIndex: 0},
