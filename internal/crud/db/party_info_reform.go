...
func (v *partyInfoTableType) Columns() []string {
	return []string{"party_id", "old_party_id", "created_at", "updated_at", "product_type_name", "concentration1", "concentration2", "concentration3", "note", "year", "month", "day"}
}
...
var PartyInfoTable = &partyInfoTableType{
	s: parse.StructInfo{Type: "PartyInfo", SQLSchema: "", SQLName: "party_info", Fields: []parse.FieldInfo{{Name: "PartyID", Type: "int64", Column: "party_id"}, {Name: "OldPartyID", Type: "*string", Column: "old_party_id"}, {Name: "CreatedAt", Type: "time.Time", Column: "created_at"}, {Name: "UpdatedAt", Type: "time.Time", Column: "updated_at"}, {Name: "ProductTypeName", Type: "string", Column: "product_type_name"}, {Name: "Concentration1", Type: "float64", Column: "concentration1"}, {Name: "Concentration2", Type: "float64", Column: "concentration2"}, {Name: "Concentration3", Type: "float64", Column: "concentration3"}, {Name: "Note", Type: "*string", Column: "note"}, {Name: "Year", Type: "int64", Column: "year"}, {Name: "Month", Type: "int64", Column: "month"}, {Name: "Day", Type: "int64", Column: "day"}}, PKFieldIndex: 0},
